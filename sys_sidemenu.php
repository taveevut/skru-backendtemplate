<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="index.html">Project Goo</a>
...
<aside class="app-sidebar">
   ...
   <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="./custome.php"><i class="app-menu__icon fa fa-user-circle-o"></i><span class="app-menu__label">ลูกค้า</span></a></li>
